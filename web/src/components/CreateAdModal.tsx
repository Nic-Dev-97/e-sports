...
export function CreateAdModal() {
    ...
    return (
        <Dialog.Portal>
            ...
            <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 rounded-lg w-[480px] text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 shadow-black/25" >
                ...
                <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <Input id='name' name='name' placeholder='Como te chamam dentro do game'></Input>
                    </div>
