      ...
      <div className="grid grid-cols-6 gap-6 mt-16">
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            ...
            <span className="text-zinc-300 text-sn block">1 anúncios</span>
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            ...
            <span className="text-zinc-300 text-sn block">3 anúncios</span>
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            ...
            <span className="text-zinc-300 text-sn block">6 anúncios</span>
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            ...
            <span className="text-zinc-300 text-sn block">2 anúncios</span>
